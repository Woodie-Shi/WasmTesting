...
int main() {
    init();
    test(var_0, var_2, var_4, var_7, var_8, var_9, var_10, var_12, var_13, var_14, var_15, var_16, var_18, zero, arr_0 , arr_1 , arr_3 , arr_4 , arr_6 , arr_7 , arr_8 , arr_9 , arr_12 , arr_13 , arr_14 );
    checksum();
    printf("%llu\n", seed);
}
